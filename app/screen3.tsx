...
import { searchAnime, AnimeDetail } from "@/services/animeApi";

const ANIME_ID = 3; // One Piece
...
export default function Screen3() {
  ...
  /* CONTEXT */
  const { setOnePieceCharacter } = useAnime();
    ...
    try {
      ...
      if (filtered.length === 0) {
        ...
        Toast.show({
          ...
          text2:
            "Solo se permiten personajes de One Piece",
        });
  ...
  return (
    ...
    <ImageBackground
      source={{
        uri: "https://raw.githubusercontent.com/J94rubio/anime_images/main/one_piece/background/background.png",
      }}
        ...
        <SafeAreaView style={styles.container}>
          ...
          >
            ...
            <SearchCard
              ...
              loading={loading}
              placeholder="Buscar personaje de One Piece..."
            />
