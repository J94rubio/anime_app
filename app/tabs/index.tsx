    ...
    try {
      ...
      if (filtered.length === 0) {
        Toast.show({
          ...
          text2: "Solo se permiten personajes de Saint Seiya",
        });
      ...
      /* 🔥 ACTUALIZACIÓN EN CONTEXT (CORRECTO) */
...
//           type: "info",
//           text1: "Anime incorrecto",
//           text2: "Solo se permiten personajes de Caballeros del Zodiaco",
//         });
